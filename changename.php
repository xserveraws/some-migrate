...
<div class="container">
  ...
  <article class="content">
    ...
    <p>
    <form method="post" action="changename.php" name="changename">
    <table>
    <tr>
    <td>First Name:</td><td> <input type="text" name="finame" required><br></td>
    </tr>
    <tr>
    <td>Last Name:</td><td> <input type="text" name="laname" required><br></td>
    </tr>
    </table><br>
    ...
    <?php
      ...
      $newfname = $_POST['finame'];
      $newlname = $_POST['laname'];
      $connect = mysqli_connect("localhost","root","");
      mysqli_select_db($conn,"some");
      $queryget = mysqli_query($conn,"SELECT fname,lname FROM user WHERE id='$id'") or die("Something went wrong!");
      $row = mysqli_fetch_assoc($queryget);
      $querychange = mysqli_query($conn,"UPDATE user SET fname='$newfname' WHERE id='$id'");
      $querychange1 = mysqli_query($conn,"UPDATE user SET lname='$newlname' WHERE id='$id'");
