...
<script>
  function passwordvalid() {
    ...
    var y = document.forms["changepassword"]["repeatnewpassword"].value;
    if (x != y) {
...
<div class="container">
  ...
  <article class="content">
    ...
    <p>
    <form method="post" action="changepassword.php" name="changepassword" onsubmit="return passwordvalid();">
    <table>
    <tr>
    <td>Old password:</td><td> <input type="password" name="oldpassword"><br></td>
    </tr>
    <tr>
    <td>New password:</td><td> <input type="password" name="newpassword"><br></td>
    </tr>
    <tr>
    ...
    <?php
      ...
      $queryget = mysqli_query($conn,"SELECT password FROM user WHERE id='$id'") or die("Something went wrong!");
      $row = mysqli_fetch_assoc($queryget);
      $oldpassworddb = $row['password'];

      if($oldpassworddb == $oldpassword){
      $querychange = mysqli_query($conn,"UPDATE user SET password='$newpassword' WHERE id='$id'");
