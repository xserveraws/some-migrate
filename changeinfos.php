...
<div class="container">
  ...
  <article class="content">
    ...
    <p>
    <form method="post" action="changeinfos.php" name="changeinfos">
    <table>
    <tr>
    <td>Country:</td><td> <input type="text" name="country" required><br></td>
    </tr>
    <tr>
    <td>Town:</td><td> <input type="text" name="town" required><br></td>
    </tr>
    <tr>
    <td>Birthday (yyyy-mm-dd):</td><td> <input type="date" name="birthday" required><br></td>
    </tr>
    <tr><td>
    ...
    <?php
      ...
      $queryget = mysqli_query($conn,"SELECT gender,birthday,country,town FROM user WHERE id='$id'") or die("Something went wrong!");
      $row = mysqli_fetch_assoc($queryget);
      $querychange = mysqli_query($conn,"UPDATE user SET gender='$gender' WHERE id='$id'");
      $querychange1 = mysqli_query($conn,"UPDATE user SET birthday='$birthday' WHERE id='$id'");
      $querychange = mysqli_query($conn,"UPDATE user SET country='$country' WHERE id='$id'");
      $querychange1 = mysqli_query($conn,"UPDATE user SET town='$town' WHERE id='$id'");
      echo '<script type="text/javascript">alert("Data changed successfully!");</script>';
      }  
    ?>
    </section>
  </article>
