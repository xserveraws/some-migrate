...
<div class="container">
  ...
  <article class="content">
    ...
    <p>
    <form method="post" action="changeusername.php" name="changeusername">
    <table>
    <tr>
    <td>New Username:</td><td> <input type="text" name="newusername"><br></td>
    </tr>
    </table><br>
    ...
    <?php
      ...
      $querychange = mysqli_query($conn,"UPDATE user SET username='$newusername' WHERE id='$id'");
