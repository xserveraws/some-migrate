...
mkdir("images/users/".$id."/photocover");
mkdir("images/users/".$id."/photocover/".$timenow."/");
$target_dir = "images/users/".$id."/photocover/".$timenow."/";
...
$imageFileType = pathinfo($target_file,PATHINFO_EXTENSION);
    if(isset($_POST["submit"])) {
          ...
          $queryget = mysqli_query($conn,"SELECT photocover FROM user WHERE id='$id'") or die("Something went wrong!");
          $row = mysqli_fetch_assoc($queryget);
          $querychange = mysqli_query($conn,"UPDATE user SET photocover='$target_file' WHERE id='$id'");
...
if ($_FILES["fileToUpload"]["size"] > 1000000) {
    ...
    $uploadOk = 0;
    $target_file = "some/images/basic/photocover.png";
          $querychange = mysqli_query($conn,"UPDATE user SET photocover='$target_file' WHERE id='$id'");
}
...
&& $imageFileType != "gif" ) {
    ...
    $uploadOk = 0;
    $target_file = "images/basic/photocover.png";
          $querychange = mysqli_query($conn,"UPDATE user SET photocover='$target_file' WHERE id='$id'");
}
if ($uploadOk == 0) {
