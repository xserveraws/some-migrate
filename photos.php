...
<div class="container">
  ...
  <article class="content">
    <h1>Photos on Timeline:</h1>
    <section>
      Photos on profile:<br>
      <a href="photoalbum.php?id=<?php echo $_GET["id"]; ?>">
      <img style="border: 5px; width: 100%; height: 100%;max-width: 200px;max-height: 130px; object-fit: cover;" src="
        <?php
  ...
  $ses_sql=mysqli_query($conn,"select  *  from  user  where  id='$user_check'  ");
  $row=mysqli_fetch_array($ses_sql,MYSQLI_ASSOC);
  $photologprofile1=$row['photoprofile'];
        echo $photologprofile1;
        ?>
        ">
      </a>
    </section>
