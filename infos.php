...
<title>Informations about: <?php echo $fname;?> <?php echo $lname;?></title>
...
<div class="container">
  ...
  <div class="sidebar1">
    <ul class="navi">
    <li><a href='profile.php?id=<?php echo $_GET["id"]; ?>'>Wall</a></li></b>
    ...
    <li><a href="following.php?id=<?php echo $_GET["id"]; ?>">Following</a></li>
          ...
          if($email == $_SESSION['email']){
            echo "<b><li><a href='infos.php?id=".$id." '>Infos</a></li></b>";
  ...
  <article class="content">
    ...
    <section>
      ...
      <p><strong>Town: </strong> <?php echo $town;?></p>
      <p><strong>Birthday: </strong>
      <?php
      $new_date = date_format(date_create($birthday), 'Y');
      echo (date("Y") - $new_date) . " years old";
      ?>
      |
      <?php echo $birthday;?>
      </p>
