...
<div class="container">
  ...
  <article class="content">
    ...
    <p>
    <form method="post" action="changephone.php" name="changephone">
    <table>
    <tr>
    <td>Old phone:</td><td> <input type="text" pattern="^\d{10}$" name="oldphone"><br></td>
    </tr>
    <tr>
    <td>New phone:</td><td> <input type="text" pattern="^\d{10}$" name="newphone"><br></td>
    </tr>
    </table><br>
    ...
    <?php
      ...
      $queryget = mysqli_query($conn,"SELECT phone FROM user WHERE id='$id'") or die("Something went wrong!");
      $row = mysqli_fetch_assoc($queryget);
      $oldphone = $row['phone'];
      if($oldphone == $_POST['oldphone']){
      $querychange = mysqli_query($conn,"UPDATE user SET phone='$newphone' WHERE id='$id'");
      echo '<script type="text/javascript">alert("Phone changed successfully!");</script>';
      }else{
      echo '<script type="text/javascript">alert("Wrong old phone!");</script>';
      }
  }  
    ?>
    </section>
